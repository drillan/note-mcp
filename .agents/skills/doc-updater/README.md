...
このディレクトリには、CodexのAgent Skill `doc-updater`が含まれています。

## ファイル構成

```
.agents/skills/doc-updater/
...
Codexを使用してコードを変更すると、このスキルが自動的に起動条件を判断し、必要に応じて起動します。
...
このスキルは `.codex/docs.md` に記載されたプロジェクトのドキュメント標準に準拠します。
...
`.codex/docs.md`に適切な設定を記載することで、任意のドキュメンテーションシステムに対応できます。

## 参考資料

- [Codex Agent Skills](https://developers.openai.com/codex/skills)
- [プロジェクトのCLAUDE.md](../../CLAUDE.md)
- [プロジェクトのドキュメント標準](.codex/docs.md)

...
# 例3: /refactor-scan custom.md --path src/note_mcp/agents --threshold 0.90
...
```bash
# 全体スキャン（高閾値）
similarity-py src/note_mcp --threshold 0.85 --min-lines 15 --cross-file --print

# Browser operations詳細スキャン
similarity-py src/note_mcp/browser --threshold 0.80 --min-lines 10 --print

# API operations詳細スキャン
similarity-py src/note_mcp/api --threshold 0.75 --min-lines 15 --print

# Utilities詳細スキャン
similarity-py src/note_mcp/utils --threshold 0.80 --min-lines 8 --print
```
  ...
  duplication-check:
    ...
    steps:
      ...
      - name: Check duplications
        run: similarity-py src/note_mcp --threshold 0.85 --min-lines 15
```
...
<details>
<summary>Browser operationsスキャン結果</summary>
...
<details>
<summary>API operationsスキャン結果</summary>
...
<details>
<summary>Utilitiesスキャン結果</summary>
...
**Report Version**: 1.0
**Generated by**: Codex `/refactor-scan` command

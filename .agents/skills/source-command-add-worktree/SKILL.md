---
name: "source-command-add-worktree"
description: "issue\u756a\u53f7\u3092\u6307\u5b9a\u3057\u3066git worktree\u3092\u65b0\u898f\u4f5c\u6210\u3059\u308b"
---

# source-command-add-worktree

Use this skill when the user asks to run the migrated source command `add-worktree`.
...
> ブランチ・ワークツリーの命名規則は `.codex/git-conventions.md` を参照してください。

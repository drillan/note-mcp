---
name: "source-command-speckit-verify"
...
# source-command-speckit-verify

Use this skill when the user asks to run the migrated source command `speckit.verify`.

...
- **FR-011**: テストはH2/H3見出し、打消し線、コードブロック、テキスト配置の各Markdown記法をサポートしなければならない
...
- **SC-005**: H2/H3見出し、打消し線、コードブロック、テキスト配置の4種類以上のMarkdown記法が検証可能

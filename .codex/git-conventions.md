...
| ファイル | 参照方法 | 備考 |
|---------|---------|------|
| `AGENTS.md` | 直接参照 | Codex用プロジェクト指示 |
| `.specify/memory/constitution.md` | リンク参照 | Article 11から参照 |
| `.agents/skills/source-command-start-issue/SKILL.md` | リンク参照 | Step 3でロジックのみ記述 |
| `.agents/skills/source-command-add-worktree/SKILL.md` | リンク参照 | Worktree命名規則を参照 |
| `.agents/skills/issue-reporter/SKILL.md` | リンク参照 | パースパターンを参照 |
| `.agents/skills/source-command-merge-pr/SKILL.md` | リンク参照 | worktree命名規則を参照 |
